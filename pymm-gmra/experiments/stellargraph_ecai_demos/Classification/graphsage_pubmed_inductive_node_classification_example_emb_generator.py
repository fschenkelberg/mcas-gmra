...
# Define the layer sizes to loop through
layer_sizes_list = [32, 64, 128, 256]

for layer_size in layer_sizes_list:
    graphsage_model = GraphSAGE(
        layer_sizes=[layer_size, layer_size], generator=generator, bias=True, dropout=0.5,
    )
    ...
    output_path = os.path.join(output_dir, f"graphsage_pubmed_inductive_node_classification_{layer_size}.txt")
